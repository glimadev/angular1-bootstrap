(function (window, angular, vitali, undefined) {
    'use strict';
          ...
          return {
              ...
              link: function (scope, element, attrs) {
                  ...
                  scope.$watch(attrs.dwLoadingOptions, function (options) {
                      ...
                      // Build template
                      var body = angular.element('<div><img src="../../../../../../Content/images/loading.gif" width="' + scope.options.loadSize + '" height="' + scope.options.loadSize + '" /></div>')
